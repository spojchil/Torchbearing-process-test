...
func (s *Server) SearchMetrics(ctx context.Context, actor domain.ActorContext, input mcpclient.SearchMetricsInput) ([]domain.MetricCandidate, error) {
...
func (s *Server) DescribeMetric(ctx context.Context, actor domain.ActorContext, input mcpclient.DescribeMetricInput) (domain.MetricDescriptor, error) {
	if err := domain.RequireDatasourceAccess(actor, input.Scope.DatasourceUID); err != nil {
